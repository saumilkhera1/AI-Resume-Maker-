...
#===============RESUME GENERATOR =============
#===============RESUME GENERATOR =============
prompt="""you are a helpful ai assistant  with a job resume maker , your task is to give html gormat resume ,with
a proper designing using recent html js css code , with professional degsine format , user will upload data and return html
format resume make it diffrent colour scheme andthe resume should project m skill set  also make it look like professional , c
reate side margins table also make the text gradient for heddings like professional summary. also constanly change design and color pallet of the resume.
...
LOCATION = st.sidebar.multiselect('SELECT LOCATION :- ',
                                 options = OPTIONS)
JOB_PROFILE = ["PYTHON DEVLOPER","GEN AI EXPERT","FULLSTACK DEVELPER"]
PROFILE = st.sidebar.multiselect('SELECT PROFILES :- ',
                                 options = PROFILE)
...
apply link THE RESULT SHOULD BE IN HTML AND NO MARKDOWN SHOULD BE THERE """
